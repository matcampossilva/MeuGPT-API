...
async def whatsapp_webhook(request: Request):
    ...
    if precisa_direcionamento(incoming_msg):
        resposta = (
            "Claro. Vamos direto ao que interessa.\n\n"
            "Se você tá meio perdido, a melhor forma de começar é com o que você **já gastou** nos últimos dias. "
            "Anota aí o que lembrar: valor, descrição e como pagou (crédito, pix, etc.).\n\n"
            "A partir disso eu organizo tudo e te dou um resumo claro.\n"
            "Se a dúvida for outra (tipo dívida, planejamento ou só caos mental), manda também. "
            "Eu encaixo no que for prioridade. Tá comigo?"
        )
