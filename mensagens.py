...
def orientacao_controle_gastos():
    return (
        ...
        "2️⃣ *Registrar gastos diários:* ajuda no controle dos gastos variáveis e permite acompanhar de perto seu comportamento financeiro em tempo real, corrigindo pequenos hábitos antes que eles se tornem grandes problemas na fatura.\n\n"
